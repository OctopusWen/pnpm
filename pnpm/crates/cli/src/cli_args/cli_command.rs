...
pub struct CliArgs {
    ...
    #[clap(flatten)]
    pub network: CliNetworkArgs,
    #[clap(flatten)]
    pub output: CliOutputArgs,
    #[clap(flatten)]
    pub workspace: CliWorkspaceArgs,
}
...
pub struct CliOutputArgs {
    ...
    #[clap(flatten)]
    pub lifecycle: LifecycleOutputArgs,
}

#[derive(Debug, Clone, clap::Args)]
pub struct CliWorkspaceArgs {
    ...
    #[clap(flatten)]
    pub ordering: WorkspaceOrderingArgs,
    #[clap(flatten)]
    pub execution: WorkspaceExecutionArgs,
}
...
#[derive(Debug, Clone, clap::Args)]
pub struct WorkspaceOrderingArgs {
...
#[derive(Debug, Clone, clap::Args)]
pub struct WorkspaceExecutionArgs {
...
#[derive(Debug, Clone, clap::Args)]
pub struct LifecycleOutputArgs {
    ...
    #[clap(id = "no_reporter_hide_prefix")]
    pub no_hide_prefix: bool,
}
